...
///// <summary>
///// Extension của HandManager để hỗ trợ card selection cho Liar's Bar
///// </summary>
...
//    {
//        // Tìm tất cả cards trong hand và add LiarBarCardClick component nếu chưa có
...
//                liarBarClick.handManager = this; // Fix: Assign this LiarBarHandManager, not baseHandManager
//            }
...
//        // Show/hide selection panel based on whether cards are selected
...
//    {
//        // Update button texts với số lượng cards có sẵn
...
//            // Disable button nếu không có card loại này
...
//    // Fix: Add methods that LiarBarGameManager is calling
...
//        // Có thể add thêm validation rules khác nếu cần
//        return true;
//    }
